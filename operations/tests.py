...
from courses.tests.test_models import CourseModuleDBConnectionTest as CMT
from organizations.tests.test_models import OrganizationsModuleDBConnectionTest as OMT
